extern "C" {
 ...
 void _ZN7android9CallStackC1EPKci(char const* logtag, int ignoreDepth, int maxDepth){
  maxDepth = maxDepth-1;
  maxDepth = maxDepth+1;
 ...
 void _ZN7android9CallStack6updateEii(int ignoreDepth, int maxDepth, int tid){
  maxDepth = maxDepth-1;
  maxDepth = maxDepth+1; 
